...
/**
 * 自定义url处理  作废 使用 http servlet wrapper方式增加统一前缀
 *
 * @author ming
 * @date 2018-01-25 10:50
 */
@Deprecated
public class MyUrlPathHelper extends UrlPathHelper {
    ...
    private static final Log logger = LogFactory.getLog(org.springframework.web.util.UrlPathHelper.class);
    ...
    private boolean shouldRemoveTrailingServletPathSlash(HttpServletRequest request) {
        ...
        if (websphereComplianceFlag == null) {
            ClassLoader classLoader = org.springframework.web.util.UrlPathHelper.class.getClassLoader();
