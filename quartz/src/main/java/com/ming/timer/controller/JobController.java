...
public class JobController extends BaseAbstractController {
     ...
     */
    @DeleteMapping
    public Boolean deleteJob(@RequestParam String jobName) {
     ...
     */
    @GetMapping("page")
    public List<Map<String,Object>> getJobPage(@RequestParam(defaultValue = "1") Integer pageNo,@RequestParam(defaultValue = "10")Integer pageSize) {
        return simpleScheduler.page(pageNo,pageSize);
    }
