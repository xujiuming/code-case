...
public class JobExecuteLogController extends BaseAbstractController {
     ...
     */
    @GetMapping("page")
    public Page<QrtzJobExecuteLog> getJobLog(@RequestParam(defaultValue = "1") Integer pageNo,@RequestParam(defaultValue = "10")Integer pageSize) {
        return qrtzJobExecuteLogService.findPage(buildPageable(pageNo,pageSize));
    }
}
