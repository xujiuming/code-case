package com.ming.scheduler.entity;
...
public class ScheduleJobConfig extends InId {
    ...
    /**
     * 任务类型
     * {@linkplain JobVO.JobType#type  任务类型}
     */
    ...
    /**
     * 下次触发时间，来自SCHE_TRIGGERS表.在触发器状态从`ACQUIRED`变成`BLOCKED`时，就会更新PREV_FIRE_TIME、nextFireTime。然后定时任务才正式开始执行
     */
    ...
    public enum JobType {
        ...
        JobType(Integer type, String name) {
            this.type = type;
            this.name = name;
        }
    }
