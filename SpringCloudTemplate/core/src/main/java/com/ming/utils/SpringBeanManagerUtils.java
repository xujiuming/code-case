...
public class SpringBeanManagerUtils implements ApplicationContextAware, DisposableBean, ApplicationEventPublisherAware {
     ...
     * 推送 指定spring 事件
     *
     * @param eventObject 监听事件
     * @author ming
     * @date 2019-10-24 13:56:23
     */
    ...
    private static void updateApplicationContext(ApplicationContext applicationContext) {
        SpringBeanManagerUtils.applicationContext = applicationContext;
    }

    private static void updateDefaultListableBeanFactory(DefaultListableBeanFactory defaultListableBeanFactory) {
        SpringBeanManagerUtils.defaultListableBeanFactory = defaultListableBeanFactory;
    }
